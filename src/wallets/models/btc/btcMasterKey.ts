...
interface IBTCMasterKey extends Document {
...
const BTCMasterKeySchema: Schema<IBTCMasterKey> = new Schema({
...
BTCMasterKeySchema.pre('save', function (next) {
...
// Decryption method
BTCMasterKeySchema.methods.decryptMasterXpriv = function () {
...
const BTCMasterKey = mongoose.model<IBTCMasterKey>('BTCMasterKey', BTCMasterKeySchema);
