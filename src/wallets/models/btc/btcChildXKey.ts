...
interface IBTCChildXKey extends Document {
...
const BTCChildXKeySchema: Schema<IBTCChildXKey> = new Schema({
...
BTCChildXKeySchema.pre('save', function (next) {
...
// Decryption method
BTCChildXKeySchema.methods.decryptChildXpriv = function () {
...
const BTCChildXKey = mongoose.model<IBTCChildXKey>('BTCChildXKey', BTCChildXKeySchema);
